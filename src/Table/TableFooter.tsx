...
export default function TableFooter({children,className,...rest}:TableFooterProps) {
    return(<tfoot className={classNames('table-footer-group',{[className||'']:className,})} {...rest}>
        {children}
    </tfoot>)
}