...
export declare function Alert({ children, severity, action, onClose, variant, className, classes, closeText, icon, iconMapping, slots, slotProps, ...rest }: AlertProps): JSX_2.Element;

export declare interface AlertProps extends Omit<PaperProps, 'children' | 'variant'> {
    children?: ReactNode;
...
export declare function AlertTitle({ children, className, ...rest }: AlertTitleProps): JSX_2.Element;
...
declare type AnchorReactProps = DetailedHTMLProps<AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>;

declare type AnchorReactProps_2 = DetailedHTMLProps<AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>;
...
export declare function Button({ children, variant, onClick, color, disabled, href, disableElevation, disableRipple, size, startIcon, endIcon, className, classes, component, fullWidth, id, ...rest }: ButtonPropsForAnchor | ButtonPropsForButton): JSX_2.Element;

export declare interface ButtonPropsForAnchor extends CommonProps, Omit<AnchorReactProps, 'color'> {
    href: string;
    onClick?: (ev: MouseEvent_2<HTMLAnchorElement>) => void;
}

declare interface ButtonPropsForAnchor_2 extends CommonProps_2, AnchorReactProps_2 {
    href: string;
    onClick?: (ev: MouseEvent_2<HTMLAnchorElement>) => void;
}

export declare interface ButtonPropsForButton extends CommonProps, Omit<ButtonReactProps, 'color'> {
    onClick?: (ev: MouseEvent_2<HTMLButtonElement>) => void;
    href?: undefined;
}

declare interface ButtonPropsForButton_2 extends CommonProps_2, ButtonReactProps_2 {
    onClick?: (ev: MouseEvent_2<HTMLButtonElement>) => void;
    href?: undefined;
}

declare type ButtonReactProps = DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>;

declare type ButtonReactProps_2 = DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>;

export declare function ClickAway({ onClickaway, children, }: {
...
declare type DivReactProps = DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>;

declare type DivReactProps_2 = DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
...
export declare type FormControlContextType = {
    ...
    contextColor?: 'primary' | 'secondary' | 'error' | 'warning' | 'info' | 'success';
...
export declare type InputContextType = {
    ...
    setValue?: Dispatch<SetStateAction<string | ReadonlyArray<string> | number | undefined>>;
...
export declare const leftMargin: (placement?: 'bottom-end' | 'bottom-start' | 'bottom' | 'left-end' | 'left-start' | 'left' | 'right-end' | 'right-start' | 'right' | 'top-end' | 'top-start' | 'top') => 0 | -14;

declare type LiReactProps = DetailedHTMLProps<LiHTMLAttributes<HTMLLIElement>, HTMLLIElement>;

export declare function Menu({ children, open, onClose, classes, MenuListProps, PopoverClasses, ...rest }: MenuProps): JSX_2.Element;

export declare function MenuItem({ children, className, component, dense, disableGutters, divider, onClick, selected, ...rest }: MenuItemProps): JSX_2.Element;
...
export declare function MenuList({ children, ...rest }: MenuListProps): JSX_2.Element;
...
export declare function Paper({ children, className, component, elevation, square, variant, ...rest }: PaperProps): JSX_2.Element;
...
export declare const setPopoverPosition: (anchorReference: 'anchorEl' | 'anchorPosition', marginThreshold: number, transformOrigin?: {
    horizontal?: 'center' | 'left' | 'right';
    vertical?: 'bottom' | 'center' | 'top';
}, anchorOrigin?: {
    horizontal?: 'center' | 'left' | 'right';
...
export declare interface SnackBarProps extends DivReactProps_3 {
    ...
    transition?: 'fade' | 'grown' | 'slideUp' | 'slideDown' | 'slideLeft' | 'slideRight';
}
...
export declare function Table({ children, className, component, padding, size, stickyHeader, ...rest }: TableProps): JSX_2.Element;

export declare function TableBody({ children, className, component, ...rest }: TableBodyProps): JSX_2.Element;
...
declare type TableBodyReactProps = DetailedHTMLProps<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;

export declare function TableCell({ children, align, className, component, padding, size, variant, ...rest }: TableCellProps): JSX_2.Element;
...
declare type TableCellReactProps = DetailedHTMLProps<TdHTMLAttributes<HTMLTableCellElement>, HTMLTableCellElement>;

export declare function TableContainer({ children, component, ...rest }: TableContainerProps): JSX_2.Element;
...
declare type TableContainerReactProps = DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
...
export declare function TableFooter({ children, className, component, ...rest }: TableFooterProps): JSX_2.Element;
...
declare type TableFooterReactProps = DetailedHTMLProps<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;

export declare function TableHead({ children, className, component, ...rest }: TableHeadProps): JSX_2.Element;
...
declare type TableHeadReactProps = DetailedHTMLProps<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;
...
export declare interface TooltipProps {
    ...
    id?: string;
    leaveDelay?: number;
    onClose?: (ev: FocusEvent_2<HTMLDivElement> | MouseEvent_2<HTMLDivElement>) => void;
    onOpen?: (ev: FocusEvent_2<HTMLDivElement> | MouseEvent_2<HTMLDivElement> | TouchEvent_2<HTMLDivElement>) => void;
    className?: string;
}

export declare const topMargin: (placement?: 'bottom-end' | 'bottom-start' | 'bottom' | 'left-end' | 'left-start' | 'left' | 'right-end' | 'right-start' | 'right' | 'top-end' | 'top-start' | 'top') => 0 | -14;

declare type UlReactProps = DetailedHTMLProps<HTMLAttributes<HTMLUListElement>, HTMLUListElement>;
